...
public:
  // constructor
  HotkeyApp(int &argc, char **argv)
      : QApplication(argc, argv), videoWin(nullptr) {}
...
#ifdef __linux__
  // Force both Qt and GStreamer to use X11 (XWayland)
  // Wayland natively prevents passing raw window IDs between Qt and external processes.
